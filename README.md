...
| `pbs_Ops.Schedule` | Schedule board, session detail, create/edit, bulk & AI upload | `releases/PBSSchedule_managed_1.2.1.zip` | [`docs/schedule-canvas-setup.md`](docs/schedule-canvas-setup.md) |
