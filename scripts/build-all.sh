...
set -euo pipefail
cd "$(dirname "$0")/.."
for c in Dashboard ReportReview ReportDetail PayrollRuns PayrollRunDetail HostList HostDetail HostDashboard MyReports MyReportDetail MySchedule ScheduleDetail; do
